...
set output 'l1_go_vortex.eps'

set title 'L1 Cache Size vs. L1 Cache Miss Rate vs. Average Access Time'
set grid
...
plot 'l1_go_vortex' using 1:2 index 0 with linespoints ls 1 axes x1y1 title 'mr-go-sa=1',    \
     '' using 1:3 index 0 title 'aat-go-sa=1' with linespoints ls 5 axes x1y2,          \
     '' using 1:2 index 1 title 'mr-go-sa=8' with linespoints ls 2 axes x1y1,            \
     '' using 1:3 index 1 title 'aat-go-sa=8' with linespoints ls 6 axes x1y2,           \
     '' using 1:2 index 2 title 'mr-vortex-sa=1' with linespoints ls 3 axes x1y1,          \
     '' using 1:3 index 2 title 'aat-vortex-sa=1' with linespoints ls 7 axes x1y2,         \
     '' using 1:2 index 3 title 'mr-vortex-sa=8' with linespoints ls 4 axes x1y1,        \
     '' using 1:3 index 3 title 'aat-vortex-sa=8' with linespoints ls 8 axes x1y2
